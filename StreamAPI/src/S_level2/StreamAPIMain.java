...
public class StreamAPIMain {
	...
	public static void main(String[] args) {
		...
		Account a1 = new Account(1,"Pranay", 20000,"Nagpur");
		Account a2 = new Account(2,"Shekhar", 1000,"Satara");
		Account a3 = new Account(3,"Sanket", 3000,"Sangli");
		...
		System.out.println("\n-----Print All Accounts by using forEach()----\n");
		callForEach();

 

		System.out.println("\n-----Accounts By Balance Less Than 10000-----\n");
		List<Account> list3 = getBalanceBelow();
		list3.stream().forEach(acc->System.out.println(acc));

 

		System.out.println("\n----Crediting Intrest On Savings-------------\n");
